...
const file_protob_message_proto_rawDesc = "" +
	"\n" +
	"\x14protob/message.proto\x12\x0ebinance.tsslib\x1a\x19google/protobuf/any.proto\x1a\x16protob/signature.proto\"\xf8\x03\n" +
	...
	"\n" +
	"trackingID\x18\v \x01(\v2\x1a.binance.tsslib.TrackingIDH\x00R\n" +
	...
	"\v_trackingIDB\aZ\x05./tssb\x06proto3"

var (
	file_protob_message_proto_rawDescOnce sync.Once
	file_protob_message_proto_rawDescData []byte
)

func file_protob_message_proto_rawDescGZIP() []byte {
	file_protob_message_proto_rawDescOnce.Do(func() {
		file_protob_message_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_protob_message_proto_rawDesc), len(file_protob_message_proto_rawDesc)))
	})
...
func file_protob_message_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_protob_message_proto_rawDesc), len(file_protob_message_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
